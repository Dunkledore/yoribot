...
class Developers:
	...
	async def updatetables(self, ctx):
		statements = ["CREATE TABLE IF NOT EXISTS guild_config (guild_id BIGINT PRIMARY KEY, mod_role_id BIGINT, "
		              ...
		              "message_log_channel_id BIGINT, invite_log_channel_id BIGINT, strike_log_channel_id BIGINT, blacklist BIGINT[], whitelist BOOL DEFAULT False, mod_participation DEFAULT FALSE,"
