...
class Convert:
    ...
    async def moneyconvert(self, ctx, amount: float, base: str, to: str):
        """Base is the money to convert from and to is the money to convert to. Available currencies for conversion: AUD BGN BRL CAD CHF CNY CZK DKK EUR GBP HKD HRK HUF IDR ILS INR JPY KRW MXN MYR NOK NZD PHP PLN RON RUB SEK SGD THB TRY USD ZAR"""
