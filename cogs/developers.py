...
class Developers:
	...
	async def updatetables(self, ctx):
		statements = ["CREATE TABLE IF NOT EXISTS guild_config (guild_id BIGINT PRIMARY KEY, mod_role_id BIGINT, "
		              ...
		              "BIGINT, time TIMESTAMP NOT NULL DEFAULT NOW(), prefix TEXT, command_name TEXT)",
		              ...
		              "user_id BIGINT, guild_id BIGINT, reason TEXT, report_message_id BIGINT, time TIMESTAMP NOT NULL DEFAULT NOW())",
		              "CREATE TABLE IF NOT EXISTS message_logs (message_id BIGINT PRIMARY KEY, content TEXT, author_id "
		              "BIGINT, "
		              "channel_id BIGINT, guild_id BIGINT, status TEXT, time TIMESTAMP NOT NULL DEFAULT NOW())"
		              ]
