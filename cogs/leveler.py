...
class Leveler:
    ...
    async def draw_profile(self, user, server):
        ...
        bg_image = bg_image.crop((0,0, 400, 300))
        result.paste(bg_image, (0,0))

        # draw filter
        draw.rectangle([(0,0),(400, 300)], fill=(0,0,0,10))
        ...
        draw.rectangle([(100,159), (395, 212)], fill=info_color) # general content
        draw.rectangle([(100,215), (395, 285)], fill=info_color) # info content
        ...
        # draws boxes
        draw.rectangle([(5,90), (100, 285)], fill= badge_fill) # badges
        draw.rectangle([(10,90), (95, 140)], fill = rep_fill) # reps
        ...
        draw.text((self._center(7, 100, rep_text, rep_fnt), 112), rep_text, font=rep_fnt, fill=white_color)

        exp_text = "{}/{}".format(userinfo["servers"][server.id]["current_exp"],self._required_exp(userinfo["servers"][server.id]["level"])) # Exp
        exp_color = exp_fill
        draw.text((105, 75), exp_text,  font=exp_fnt, fill=(exp_color[0], exp_color[1], exp_color[2], 255)) # Exp Text
